...
st.markdown("* Such stiffened panels are typically used in hulls of ships and floating offshore structures like jack-up rigs and semi-submersibles.")
st.markdown("* Generally, the inputs are details regarding plate panel dimensions and material properties.")
...
st.markdown("* Currently, the app gives buckling state limit (UC) check if you have entered the stresses.")
st.markdown("* Even if the stresses are not input, the critical buckling state limits are calculated.")
st.markdown("* Additionally, interactive plotly charts are presented for the values of the critical buckling stresses and UCs (if stresses are supplied) for the defined panel and also for a range of aspect ratios of the panel, keeping all other inputs same.")
st.divider()
